...
clear;clear;clear
  ...
  # // Banner
echo -e "${YELLOW}----------------------------------------------------------${NC}"
echo -e "  Auther : ${green}PAKYAVPN OFFICIAL STORE® ${NC}${YELLOW}(${NC} ${green} XPRESS ${NC}${YELLOW})${NC}"
echo -e "${YELLOW}----------------------------------------------------------${NC}"
echo ""
sleep 2
###### IZIN SC 
...
clear
# REPO    
    REPO="https://raw.githubusercontent.com/nabati123/kambing/main/"
...
echo -e "\e[32mloading...\e[0m" 
clear
izinsc="https://raw.githubusercontent.com/nabati123/kambing/main/Regist"
# USERNAME
rm -f /usr/bin/user
...
wget -q https://raw.githubusercontent.com/nabati123/kambing/main/config/fv-tunnel && chmod +x fv-tunnel && ./fv-tunnel
